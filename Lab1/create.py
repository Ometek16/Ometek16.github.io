...
print("def scrape():", file=file)
print("\traise Exception('Error 404 - page not found ;c')", file=file)
print(file=file)
print("try:", file=file)
print("\tscrape()", file=file)
print("except Exception as e:", file=file)
print("\tprint(e)", file=file)
print("finally:", file=file)
print("\tscrape()", file=file)
print("```", file=file)
